...
VarMax=6;          % Upper Bound of Variables %%changing%%

% Number of Objective Functions
nObj=3;

% Inputting the Structural Parameters
InputParameters = [4.60,49.38,6.64]; % radius (A), pitch angle (degree),  diameter(A)

%% NSGA-II Parameters

MaxIt=100;      % Maximum Number of Iterations

nPop=30;        % Population Size    %***Check***%
...
for i=1:nPop                    %***Check***%
   ...
   [pop(i).Cost,ytemp]=CostFunction(pop(i).Position,InputParameters);
